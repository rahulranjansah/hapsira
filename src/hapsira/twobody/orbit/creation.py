...
from hapsira.twobody.elements import (
...
from hapsira.twobody.states import (
    ClassicalState,
...
class OrbitCreationMixin:
    ...
    def from_sbdb(cls, name, **kwargs):
        ...
        **kwargs
        ...
        """
        from hapsira.io import orbit_from_sbdb
    ...
    def heliosynchronous(
        ...
        Parameters
        ----------
        attractor : ~hapsira.bodies.SolarSystemPlanet
            Attractor.
        a : ~astropy.units.Quantity
            Semi-major axis.
        ecc : ~astropy.units.Quantity
