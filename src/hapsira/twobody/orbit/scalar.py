...
from hapsira.twobody.orbit.creation import OrbitCreationMixin
from hapsira.twobody.propagation import FarnocchiaPropagator, PropagatorKind
from hapsira.twobody.sampling import TrueAnomalyBounds
from hapsira.util import norm, wrap_angle
...
class Orbit(OrbitCreationMixin):
    ...
    def change_attractor(self, new_attractor, force=False):
        ...
        Parameters
        ----------
        new_attractor : hapsira.bodies.Body
        ...
        Returns
        -------
        ss: hapsira.twobody.orbit.Orbit
    ...
    def plot(self, backend=None, label=None):
        ...
        Returns
        -------
        ~hapsira.plotting.orbit.OrbitPlotter
            An object for plotting orbits.

        """
        # HACK: avoid circular dependency
        from hapsira.plotting.orbit.backends import Matplotlib2D, Plotly2D
        from hapsira.plotting.orbit.plotter import OrbitPlotter
