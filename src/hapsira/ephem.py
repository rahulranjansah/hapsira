...
def build_ephem_interpolant(body, epochs, attractor=Earth):
    ...
    epochs : ~astropy.time.Time
        Array of time values, can be generated with hapsira.util.time_range.
    attractor : ~hapsira.bodies.Body, optional
...
class Ephem:
    ...
    def from_body(cls, body, epochs, *, attractor=None, plane=Planes.EARTH_EQUATOR):
        ...
        attractor : ~hapsira.bodies.SolarSystemPlanet, optional
            Body to use as central location,
            if not given the Solar System Barycenter will be used.
        plane : ~hapsira.frames.Planes, optional
    ...
    def sample(self, epochs=None, *, interpolator=SplineInterpolator()):
        ...
        interpolator : ~hapsira.ephem.BaseInterpolator, optional
